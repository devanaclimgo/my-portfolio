        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <motion.div
              ...
              animate={
                experienceInView ? { opacity: 1, x: 0 } : { opacity: 0, x: -50 }
              }
              transition={{ duration: 0.6, delay: 0.4 }}
              whileHover={{ scale: 1.02, y: -5 }}
            >
              <h3 className="text-xl font-bold text-white mb-2">
                {t.experience.volunteer}
              </h3>
              <p className="text-gray-300">
                Contributing to open source projects and helping local
                communities with web development needs.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-300">
                Building custom websites and web applications for small
            ...
            >
              <p className="text-[#8A6CFF] font-medium">
                {t.experience.skills}
              </p>
            </motion.div>
          </div>
